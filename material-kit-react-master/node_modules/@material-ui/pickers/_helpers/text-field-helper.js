...
exports.validate = function (value, utils, _a // DateTimePicker doesn't support
    ...
    var maxDate = _a.maxDate, minDate = _a.minDate, disablePast = _a.disablePast, disableFuture = _a.disableFuture, maxDateMessage = _a.maxDateMessage, minDateMessage = _a.minDateMessage, invalidDateMessage = _a.invalidDateMessage;
    ...
    if ((maxDate && utils.isAfter(parsedValue, utils.endOfDay(utils.date(maxDate)))) ||
        (disableFuture && utils.isAfter(parsedValue, utils.endOfDay(utils.date())))) {
        return maxDateMessage;
    }
    if ((minDate && utils.isBefore(parsedValue, utils.startOfDay(utils.date(minDate)))) ||
