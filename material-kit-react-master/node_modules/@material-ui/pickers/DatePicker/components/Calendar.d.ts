...
export declare class Calendar extends React.Component<CalendarProps, CalendarState> {
    ...
    onDateSelect: (day: MaterialUiPickersDate, isFinish?: boolean) => void;
    ...
    renderDays: (week: MaterialUiPickersDate[]) => JSX.Element[];
    render(): JSX.Element;
}
