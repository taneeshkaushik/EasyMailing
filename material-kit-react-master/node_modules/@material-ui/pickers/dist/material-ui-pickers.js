...
var ModalDialog = function (_a) {
  ...
  var children = _a.children,
      ...
      wider = _a.wider,
      other = tslib_1.__rest(_a, ["children", "classes", "onKeyDownInner", "onAccept", "onDismiss", "onClear", "onSetToday", "okLabel", "cancelLabel", "clearLabel", "todayLabel", "clearable", "showTodayButton", "showTabs", "wider"]);
...
var InlineWrapper = function (_a) {
  ...
  return React.createElement(React.Fragment, null, open && React.createElement(EventListener, {
    target: "window",
    onKeyDown: handleKeyDown
  }), React.createElement(InputComponent, tslib_1.__assign({
    inputRef: ref
  }, other, DateInputProps)), React.createElement(Popover, tslib_1.__assign({
    open: open,
    onClose: onAccept,
...
var PureDateInput = function (_a) {
  var inputValue = _a.inputValue,
      ...
      other = tslib_1.__rest(_a, ["inputValue", "inputVariant", "validationError", "InputProps"]);
  ...
  return React.createElement(TextField, tslib_1.__assign({
...
var KeyboardDateInput = function (_a) {
  var inputValue = _a.inputValue,
      ...
      format = _a.format,
      disabled = _a.disabled,
      other = tslib_1.__rest(_a, ["inputValue", "inputVariant", "validationError", "KeyboardButtonProps", "InputAdornmentProps", "onClick", "onChange", "InputProps", "mask", "maskChar", "refuse", "format", "disabled"]);
  ...
  return React.createElement(rifm.Rifm, {
    ...
    return React.createElement(TextField, tslib_1.__assign({
      ...
      InputProps: tslib_1.__assign({}, InputProps, (_b = {}, _b[position + "Adornment"] = React.createElement(InputAdornment, tslib_1.__assign({
        ...
        onClick: onClick
      }), React.createElement(KeyboardIcon, null))), _b))
    }));
  });
};
