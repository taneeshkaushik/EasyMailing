...
import React__default, { createContext, createElement, Component, useContext, useMemo, useCallback, cloneElement, Fragment, forwardRef, useRef, useEffect, useState, memo, useDebugValue } from 'react';
...
var KeyboardDateInput = function (_a) {
  var inputValue = _a.inputValue,
      ...
      format = _a.format,
      disabled = _a.disabled,
      other = __rest(_a, ["inputValue", "inputVariant", "validationError", "KeyboardButtonProps", "InputAdornmentProps", "onClick", "onChange", "InputProps", "mask", "maskChar", "refuse", "format", "disabled"]);
