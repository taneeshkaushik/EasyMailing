...
var ListItem = _react.default.forwardRef(function ListItem(props, ref) {
  ...
  var componentProps = (0, _extends2.default)({
    className: (0, _clsx.default)(classes.root, childContext.dense && classes.dense, !disableGutters && classes.gutters, divider && classes.divider, disabled && classes.disabled, button && classes.button, alignItems === 'flex-start' && classes.alignItemsFlexStart, hasSecondaryAction && classes.secondaryAction, selected && classes.selected, className),
    disabled: disabled
  }, other);
