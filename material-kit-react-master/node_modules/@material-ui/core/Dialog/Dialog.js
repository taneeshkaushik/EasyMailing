...
var Dialog = _react.default.forwardRef(function Dialog(props, ref) {
  ...
  return _react.default.createElement(_Modal.default, (0, _extends2.default)({
    ...
    className: (0, _clsx.default)(classes.paper, classes["paperScroll".concat((0, _helpers.capitalize)(scroll))], classes["paperWidth".concat((0, _helpers.capitalize)(String(maxWidth)))], fullScreen && classes.paperFullScreen, fullWidth && classes.paperFullWidth, PaperProps.className)
  }), children))));
});
