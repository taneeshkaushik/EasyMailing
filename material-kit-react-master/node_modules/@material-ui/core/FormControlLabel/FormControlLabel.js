...
var FormControlLabel = _react.default.forwardRef(function FormControlLabel(props, ref) {
  ...
  return _react.default.createElement("label", (0, _extends2.default)({
    className: (0, _clsx.default)(classes.root, labelPlacement !== 'end' && classes["labelPlacement".concat((0, _helpers.capitalize)(labelPlacement))], disabled && classes.disabled, classNameProp),
    ref: ref
