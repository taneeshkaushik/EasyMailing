...
var Tab = _react.default.forwardRef(function Tab(props, ref) {
  ...
  return _react.default.createElement(_ButtonBase.default, (0, _extends3.default)({
    ...
    className: (0, _clsx.default)(classes.root, classes["textColor".concat((0, _helpers.capitalize)(textColor))], disabled && classes.disabled, selected && classes.selected, label && icon && classes.labelIcon, fullWidth && classes.fullWidth, wrapped && classes.wrapped, className),
    ref: ref,
    role: "tab",
