...
const IconButton = React.forwardRef(function IconButton(props, ref) {
  ...
  return React.createElement(ButtonBase, _extends({
    className: clsx(classes.root, color !== 'default' && classes[`color${capitalize(color)}`], disabled && classes.disabled, size !== 'medium' && classes[`size${capitalize(size)}`], edge === 'start' && classes.edgeStart, edge === 'end' && classes.edgeEnd, className),
    centerRipple: true,
