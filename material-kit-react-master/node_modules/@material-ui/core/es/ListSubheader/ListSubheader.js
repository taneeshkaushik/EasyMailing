...
const ListSubheader = React.forwardRef(function ListSubheader(props, ref) {
  ...
  return React.createElement(Component, _extends({
    className: clsx(classes.root, color !== 'default' && classes[`color${capitalize(color)}`], inset && classes.inset, !disableSticky && classes.sticky, !disableGutters && classes.gutters, className),
    ref: ref
  }, other));
});
