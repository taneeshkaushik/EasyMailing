...
const Tab = React.forwardRef(function Tab(props, ref) {
  ...
  return React.createElement(ButtonBase, _extends({
    ...
    className: clsx(classes.root, classes[`textColor${capitalize(textColor)}`], disabled && classes.disabled, selected && classes.selected, label && icon && classes.labelIcon, fullWidth && classes.fullWidth, wrapped && classes.wrapped, className),
    ref: ref,
    role: "tab",
