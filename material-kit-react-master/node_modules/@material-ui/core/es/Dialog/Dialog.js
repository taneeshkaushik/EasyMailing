...
const Dialog = React.forwardRef(function Dialog(props, ref) {
  ...
  return React.createElement(Modal, _extends({
    ...
    className: clsx(classes.paper, classes[`paperScroll${capitalize(scroll)}`], classes[`paperWidth${capitalize(String(maxWidth))}`], fullScreen && classes.paperFullScreen, fullWidth && classes.paperFullWidth, PaperProps.className)
  }), children))));
});
