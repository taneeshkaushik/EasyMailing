(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('lodash/isPlainObject'), require('lodash/filter'), require('lodash/omit'), require('@nivo/core'), require('react-spring')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'lodash/isPlainObject', 'lodash/filter', 'lodash/omit', '@nivo/core', 'react-spring'], factory) :
    (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.PropTypes, global['lodash/isPlainObject'], global['lodash/filter'], global['lodash/omit'], global.nivo, global['react-spring']));
}(this, (function (exports, React, PropTypes, isPlainObject, filter, omit, core, reactSpring) { 'use strict';
