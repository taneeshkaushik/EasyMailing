(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('lodash/isFunction'), require('@nivo/core'), require('prop-types'), require('lodash/isNumber'), require('lodash/isPlainObject')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'lodash/isFunction', '@nivo/core', 'prop-types', 'lodash/isNumber', 'lodash/isPlainObject'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global['lodash/isFunction'], global.nivo, global.PropTypes, global['lodash/isNumber'], global['lodash/isPlainObject']));
}(this, (function (exports, React, isFunction, core, PropTypes, isNumber, isPlainObject) { 'use strict';
