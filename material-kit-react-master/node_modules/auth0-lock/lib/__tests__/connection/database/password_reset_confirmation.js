...
describe('PasswordResetConfirmation', function () {
  it('renders correctly', _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            (0, _testUtils.expectComponent)(_react2.default.createElement(_password_reset_confirmation2.default, { lock: lock })).toMatchSnapshot();
