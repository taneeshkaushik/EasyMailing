            ...
            content={
                ...
                >
                    <div className='flex justify-center p-30'>
                        <SheetUpload hardcode = {[false ,false ,false , false ,false ,false ]} color="inherit" row={rows} emailBody={emailBody} columns={columns} subject={subject} body={body} list={list} setColumns={setColumns.bind(this)} setRows={setRows.bind(this)} />
                    </div>
