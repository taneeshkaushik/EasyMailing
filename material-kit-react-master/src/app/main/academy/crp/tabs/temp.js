...
export default function NewLook(props) {
    ...
    const FIRST_TOUR = [
        {
            target: ".takeinput",
            content: "Choose a file from which you want to send emails"
        },
        {
            target: ".table",
            content: "This is the csv file you uploaded"
        },
        {
...
< div className = "justify-center items-center" >
    <div className="flex flex-col justify-center flex-1 ">
        <FuseAnimateGroup>
            <div className="flex justify-center items-center mail">
                <Typography className="py-0 sm:py-24 text-60 text-green" variant="h4">Easy Mailing </Typography>
            </div>
            <div className="flex justify-center items-center boom">
